...
def main():
    ...
    print()
    print("We will ask you to enter a 'quantity' that will determined if the phrase generated by the program" +
          "\nwill be singular or a plural phrase.")

    flag = True
    while flag:

        tense = input("\nThe tenses available to select are 'past', 'present' or 'future', please chose one: ")
        ...
        for i in range(6):
            ...
            print("Simple phrase generated by the program:")
            print(f"{determiner} {noun} {verb}")
            print()
            print("Prepositional phrase generated by the new program:")
            prepositional_phrase = get_prepositional_phrase(quantity)
            print(prepositional_phrase)

        continue_python_program = input("Would you like to continue testing this feature? Select Y/N: ")
