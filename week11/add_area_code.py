def main():
    try:
        ...
        # some phone number don't have an area code.
        print("Phone numbers before the mapping:")
        print(phone_numbers)

        # Some phone numbers in phone_numbers.txt do not start
        ...
        print("Printing the new phone numbers:")
        print(new_numbers)
...
def add_area_code(phone_number):
    ...
    Return: a string of digits formatted as "ddd-ddd-dddd"
    """
