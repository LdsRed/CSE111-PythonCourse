def main():
    ...
    if vin in vehicles_dict:
        ...
        vehicle_information = vehicles_dict[vin]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        manufacturer = vehicle_information[1]
        model = vehicle_information[2]
        color_vehicle = vehicle_information[3]
        print(f"Manufacturer: {manufacturer}, Model: {model} and Color: {color_vehicle}")
