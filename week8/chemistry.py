...
def main():
    ...
    print("Lets see if we can find this formula in our data base...%")
    ...
    element_list = parse_formula(chemical_formula, periodic_table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        ...
        atomic_mass_value = atomic_mass[ATOMIC_MASS_INDEX]
        total_molar_mass += atomic_mass_value * quantity
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        ...
        return f"The formula name is: {chemical_formula_name}"
    else:
